...
| 3   | ABSOLUTE RELIABILITY (perfect first layers, minimal print artificats, rare failed prints, etc. | With all tuning so far, reliability is already easily over 90% even with complicated/demanding first layers, nozzle wiper and wire harness well incorporated and with plans to improve furthur |
